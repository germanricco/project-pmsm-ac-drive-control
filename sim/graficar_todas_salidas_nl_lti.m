...
%% 2. Variables mecánicas y térmicas del modelo no lineal

% Estas cuatro figuras muestran únicamente la respuesta del modelo NL.
% Se exportan por separado para utilizarlas como resultados principales
% del modelo de mayor fidelidad.

exportVectorTimePlot(plotter, tThetaNL, thetaNL, ...
    "", ...
    "\theta_m (rad)", ...
    {"theta_m"}, ...
    "theta_m_nl.pdf", ...
...
exportVectorTimePlot(plotter, tWNL, wNL, ...
    "", ...
    "\omega_m (rad/s)", ...
    {"w_m"}, ...
    "w_m_nl.pdf", ...
...
exportVectorTimePlot(plotter, tTsNL, TsNL, ...
    "", ...
    "T_s (°C)", ...
    {"T_s"}, ...
    "T_s_nl.pdf", ...
...
exportVectorTimePlot(plotter, tTmNL, TmNL, ...
    "", ...
    "T_m (N·m)", ...
    {"T_m"}, ...
    "T_m_nl.pdf", ...
...
%% 3. Comparación de variables mecánicas y térmicas
...
%% 4. Corrientes en coordenadas qd0
...
%% 5. Corrientes en coordenadas abc
...
%% 6. Tensiones en coordenadas qd0
...
%% 7. Tensiones en coordenadas abc
...
%% 8. Curva paramétrica torque-velocidad
