...
\section*{5. Análisis de Controlabilidad Completa de Estado del Modelo LTI Equivalente Aumentado}
...
\subsubsection{Efecto de la condición inicial de \texorpdfstring{$i_{ds}^r$}{i\_ds\_r}}
