...
\subsection{1. Modelo matemático del subsistema mecánico}
...
\subsubsection{1.1. Carga mecánica}
...
\subsubsection{1.2. Tren de transmisión}
...
\subsubsection{1.3. Subsistema mecánico del motor}
...
\subsubsection{1.4. Obtención del modelo equivalente referido al eje del motor}
...
\subsubsection{1.5. Modelo en espacio de estados}
...
\subsubsection{1.6. Parámetros mecánicos nominales}
...
\subsubsection{1. 7. Variación de parámetros por carga útil e incertidumbre}
...
\subsubsection{1.8. Justificación de la compactación mecánica}
...
\subsubsection{1.9. Diagrama de bloques del subsistema mecánico equivalente}
...
\subsection{2. Modelo dinámico del sistema físico completo}
...
% ---------------------------------------------------------
\subsubsection{2.1. Modelo global no lineal del sistema físico completo, para \texorpdfstring{$i_{ds}^{r}(t)\neq 0$}{idsr(t)\textasciitilde 0}}
...
Sustituyendo el torque electromagnético de la PMSM dado por \eqref{eq:torque_kt_krel_p2}, resulta:
...
La Fig. \ref{fig:diagrama_electromecanico_equivalente} muestra el diagrama de bloques correspondiente al modelo electromecánico de la PMSM.

\begin{figure}[H]
	\centering
	% Inserta la ruta y nombre exacto de tu archivo PNG aquí
	\includegraphics[width=0.95\textwidth]{img/screenshot_subsistema_electromagnetico.png}
	\caption{Diagrama de bloques del subsistema electromecánico de la máquina.}
...
La Fig. \ref{fig:diagrama_termico_equivalente} muestra el diagrama de bloques correspondiente al modelo electromecánico de la PMSM.

\begin{figure}[H]
	\centering
	% Inserta la ruta y nombre exacto de tu archivo PNG aquí
	\includegraphics[width=0.95\textwidth]{img/screenshot_subsistema_termico.png}
	\caption{Diagrama de bloques del subsistema térmico de la máquina.}
...
% ---------------------------------------------------------
\subsubsection{2.2 Linealización Jacobiana: modelo global LPV}
